...
class StoryUtilsTests
{
    ...
    private static final List<Scenario> SCENARIOS = StoryUtils.getFoldScenarios(readStory("story.json"));
    ...
    void shouldNotProcessScenarioWithoutLifecycle()
    {
        ...
        assertEquals(List.of(scenario), StoryUtils.getFoldScenarios(story));
    ...
    {
        Parameters params = StoryUtils.getFoldScenarios(readStory("single-scenario-story.json")).get(0)
